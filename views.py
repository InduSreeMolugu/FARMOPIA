...
def getOutput(table,length):
    ...
    output=""
    con = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = '1234', database = 'cropinfo',charset='utf8')
    with con:
        cur = con.cursor()
        ...
        with con:
            ...
            for row in rows:
                if row[0] == username:
                    ...
                    break
        if output == 'none':
            db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = '1234', database = 'cropinfo',charset='utf8')
